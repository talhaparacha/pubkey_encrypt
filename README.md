...
3) Enable at least one of the modules providing an "Asymmetric Keys Generator" plugin.

4) Enable at least one of the modules providing a "Login Credentials Provider" plugin.

5) Initialize this module from Administration >> Configuration >> System >> Pubkey Encrypt settings.

6) See all the Encryption Profiles generated by this module from Administration >> Configuration >> System >> Pubkey Encrypt overview.

7) Enable [Field Encryption](https://www.drupal.org/project/field_encrypt) and/or [Encrypted Files](https://www.drupal.org/project/encrypted_files) module to use any of the generated Encryption Profiles.
